...
const AboutUs = (props) => {
  return (
    <div className="about-us-container">
      <Helmet>
        <title>About-us - Martin's Computer Repairs</title>
        <meta
          property="og:title"
          content="About-us - Martin's Computer Repairs"
        />
      </Helmet>
      <header data-thq="thq-navbar" className="about-us-navbar-interactive">
        <img alt="logo" src="/weblogo-1500h.png" className="about-us-image" />
