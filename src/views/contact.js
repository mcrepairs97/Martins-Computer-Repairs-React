...
const Contact = (props) => {
  return (
    <div className="contact-container">
      <Helmet>
        <title>Contact - Martin's Computer Repairs</title>
        <meta
          property="og:title"
          content="Contact - Martin's Computer Repairs"
        />
      </Helmet>
        ...
        <div data-thq="thq-mobile-menu" className="contact-mobile-menu">
          <div className="contact-nav">
            ...
            <nav className="contact-links1">
              <span className="contact-text05">About</span>
              <span className="contact-text06">Features</span>
              <span className="contact-text07">Pricing</span>
              <span className="contact-text08">Team</span>
              <span className="contact-text09">Blog</span>
            </nav>
